...
//  Beam
//
//  Created by Powermobile on 21-12-15.
...
final class SavePostActivity: SaveContentActivity<Post> {
    ...
    override var activityType: UIActivityType? {
        return UIActivityType(rawValue: "com.madePowermobile.beam.save-post")
    }
...
final class UnsavePostActivity: SaveContentActivity<Post> {
    ...
    override var activityType: UIActivityType? {
        return UIActivityType(rawValue: "com.madePowermobile.beam.unsave-post")
    }
...
final class SaveCommentActivity: SaveContentActivity<Comment> {
    ...
    override var activityType: UIActivityType? {
        return UIActivityType(rawValue: "com.madePowermobile.beam.save-comment")
    }
...
final class UnsaveCommentActivity: SaveContentActivity<Comment> {
    ...
    override var activityType: UIActivityType? {
        return UIActivityType(rawValue: "com.madePowermobile.beam.unsave-comment")
    }
