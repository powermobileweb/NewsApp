...
- (NSAttributedString *)attributedTitle {
    ...
    [title appendAttributedString:[[NSAttributedString alloc] initWithString:@"Title " attributes:@{NSFontAttributeName: [UIFont preferredFontForTextStyle:UIFontTextStyleHeadline], NSLinkAttributeName: [NSURL URLWithString:@"https://github.com/Powermobile/AWKGallery"], NSForegroundColorAttributeName: [UIColor whiteColor]}]];
