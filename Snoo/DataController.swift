...
//
//  Created by Powermobile on 30-03-15.
...
public final class DataController: NSObject {
    ...
    lazy var networkingQueue: OperationQueue = {
        ...
        queue.name = "nl.madePowermobile.snoo.networking"
    ...
    lazy var operationQueue: OperationQueue = {
        ...
        queue.name = "nl.madePowermobile.snoo.parsing"
        queue.qualityOfService = QualityOfService.userInitiated
        return queue
    }()
    
    lazy fileprivate var operationCompletionHandlerQueue: DispatchQueue = {
        return DispatchQueue(label: "nl.madePowermobile.snoo.operation-completion-handler", attributes: DispatchQueue.Attributes.concurrent)
    }()
    
    lazy fileprivate var operationExecutionHandlerQueue: DispatchQueue = {
        return DispatchQueue(label: "nl.madePowermobile.snoo.operation-execution-handler", attributes: DispatchQueue.Attributes.concurrent)
    }()
